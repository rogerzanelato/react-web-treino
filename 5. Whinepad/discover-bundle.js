...
var Form = function (_React$Component) {
    ...
    function Form(props) {
        ...
        _this.props.fields.forEach(function (field) {
            _this._refs[field.id] = _react2.default.createRef();
        });
        return _this;
    }
    ...
    _createClass(Form, [{
        ...
        value: function getData() {
            ...
            this.props.fields.forEach(function (field) {
                data[field.id] = _this2._refs[field.id].getValue();
            });
                        ...
                        return _react2.default.createElement(
                            ...
                            _react2.default.createElement(_FormInput2.default, _extends({}, field, {
                                ref: function ref(element) {
                                    return _this3._refs[field.id] = element;
                                },
...
var FormInput = function (_React$Component) {
    ...
    _createClass(FormInput, [{
        ...
        value: function getValue() {
            return 'value' in this.input ? this.input.value : this.input.getValue();
        }
    }, {
        key: 'render',
        value: function render() {
            var common = { // propriedades aplicáveis a todos
                id: this.props.id,
                ref: this.input,
...
FormInput.propTypes = {
    ...
    options: _propTypes2.default.array, // como em <options>s de preenchimento automático
...
var Rating = function (_React$Component) {
    ...
    _createClass(Rating, [{
        ...
        value: function reset() {
            // on mouseout retorna a verdadeira classificação
...
_reactDom2.default.render(_react2.default.createElement(
    ...
    _react2.default.createElement(_Form2.default, {
        fields: [{ type: 'rating', label: 'Rating', id: 'rateme' }, { type: 'input', label: 'Grettings', id: 'greetings' }],
